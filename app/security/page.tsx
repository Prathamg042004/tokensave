...
export default function Security() {
  return (
    <div className="min-h-screen bg-[#08090C] text-gray-100 relative overflow-hidden">
      <div className="absolute top-[-300px] left-[-200px] w-[600px] h-[600px] bg-emerald-500/[0.02] rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <h1 className="text-[32px] font-bold mb-2 tracking-tight bg-gradient-to-b from-white to-gray-400 bg-clip-text text-transparent">Security & Trust</h1>
