...
export async function GET() {
  const checks: any = { status: "healthy", timestamp: new Date().toISOString(), version: "3.1.0", services: {} as any };
  ...
  } catch (e: any) { checks.services.redis = { status: "error", message: e.message }; checks.status = "degraded"; }
